...
<body>
  <h4 class="text-center">Form Edit Data Barang</h4>
    ...
    <div class="form-group">
      ...
      <input type="text" name="kategori" class="form-control" value="{{$buku->no_plat}}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan No Surat">
    </div>
    <div class="form-group">
      <label for="exampleInputPassword1" class="font-weight-bold">Penerbit</label>
      <input type="text" name="nama_barang" class="form-control" value="{{$buku->merk}}" id="exampleInputPassword1" placeholder="Masukkan Tanggal Surat">
    </div>
    <div class="form-group">
        <label for="exampleInputPassword1" class="font-weight-bold">Penulis</label>
        <input type="text" name="stok" class="form-control" value="{{$buku->tipe}}" id="exampleInputPassword1" placeholder="Masukkan Judul Surat">
      </div>
      <div class="form-group">
