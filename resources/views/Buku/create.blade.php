    ...
    <div class="container mt-3">
        <form action="{{route('buku.store')}} " method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="nama_barang" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Nama Barang">
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1" class="font-weight-bold">Stok</label>
                <input type="text" name="stok" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Stok Barang">
              </div>
              <div class="form-group">
